...
function toggleFortnite() {
  ...
  if (fortniteSelect === true) {
    document.getElementById("fortnite").style.border = "5px solid yellow";
  }
  if (fortniteSelect === false) {
    document.getElementById("fortnite").style.border = "none";
    ("rgb(194, 109, 226)");
  }
}
...
function toggleCOD() {
  ...
  if (codSelect === true) {
    document.getElementById("COD").style.border = "5px solid yellow";
  }
  if (codSelect === false) {
    document.getElementById("COD").style.border = "none";
  }
}
